...
def main():
    ...
    train_dst,_ = get_dataset(opts.dataset,opts.data_root,opts.crop_size,opts.ACDC_sub,
                                    data_aug=opts.data_aug)

    _, val_dst = get_dataset('ACDC','/home/cs4007/pjh/PODA/PODA/datasets/ACDC',opts.crop_size,'night',
                                    data_aug=opts.data_aug)
